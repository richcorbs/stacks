...
export function AppOverlays(props: OverlayLayoutProps) {
  return <>
    ...
    />
    {props.settingsOpen && <SettingsDialog settings={props.appSettings} onChange={props.setAppSettings} onNotificationsUnavailable={props.notificationsUnavailable} onClose={props.closeSettings} />}
