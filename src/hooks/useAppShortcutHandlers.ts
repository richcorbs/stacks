...
export function useAppShortcutHandlers({
  ...
  openOneTimeCommand,
  openNewCard,
  openDirectProjectWork,
  openAddCmdPCommand,
  openEditCmdPCommand,
  openDeleteCmdPCommand,
  openAddWorkspaceTemplate,
  openWorkspaceTemplate,
  openEditWorkspaceTemplate,
  openDeleteWorkspaceTemplate,
  ...
  const commandPaletteItems = useCommandPaletteItems({
    ...
    onDirectProjectWork: openDirectProjectWork,
    ...
    workspaceTemplates: appSettings.workspace_templates,
    onAddWorkspaceTemplate: openAddWorkspaceTemplate,
    onUseWorkspaceTemplate: openWorkspaceTemplate,
    onEditWorkspaceTemplate: openEditWorkspaceTemplate,
    onDeleteWorkspaceTemplate: openDeleteWorkspaceTemplate,
