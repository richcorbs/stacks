...
fn shortcuts_menu(app: &AppHandle) -> tauri::Result<Submenu<tauri::Wry>> {
    let items = [
        ...
        (
            "menu-shortcut-toggle-sidebar",
            "Toggle Sidebar",
            "Cmd+B",
            Some("Cmd+B"),
        ),
        (
            "menu-shortcut-toggle-superthread",
            "Toggle Developer Services",
            "Cmd+R",
            Some("Cmd+R"),
        ),
        (
            "menu-shortcut-toggle-diff",
            "Focus / Toggle Diff Panel",
            "Cmd+G",
            Some("Cmd+G"),
        ),
        (
            "menu-shortcut-toggle-github-pull-requests",
            "Focus / Toggle Pull Requests Panel",
            "Cmd+Shift+G",
            Some("Cmd+Shift+G"),
        ),
        (
        ...
        (
            "menu-shortcut-maximize-workspace",
            "Maximize / Restore Workspace",
            "Cmd+Shift+Enter",
            Some("Cmd+Shift+Enter"),
        ),
        (
            "menu-shortcut-focus-next-terminal",
            "Focus Next Terminal",
            "Cmd+]",
            Some("Cmd+]"),
        ),
        (
            "menu-shortcut-focus-previous-terminal",
            "Focus Previous Terminal",
            "Cmd+[",
            Some("Cmd+["),
        ),
        (
            "menu-shortcut-focus-next-workspace",
            "Focus Next Workspace",
            "Cmd+Shift+]",
            Some("Cmd+Shift+]"),
        ),
        (
            "menu-shortcut-focus-previous-workspace",
            "Focus Previous Workspace",
            "Cmd+Shift+[",
            Some("Cmd+Shift+["),
        ),
        (
            "menu-shortcut-activate-sidebar",
            "Activate Sidebar Selection",
            "Cmd+Enter",
            Some("Cmd+Enter"),
        ),
        (
            "menu-shortcut-select-workspace",
