...
fn shortcuts_menu(app: &AppHandle) -> tauri::Result<Submenu<tauri::Wry>> {
    let items = [
        ...
        ("menu-shortcut-toggle-diff", "Toggle Diff Panel", "Cmd+G", Some("Cmd+G")),
        ("menu-shortcut-toggle-github-pull-requests", "Toggle GitHub Pull Requests", "Cmd+Shift+G", Some("Cmd+Shift+G")),
