...
fn shortcuts_menu(app: &AppHandle) -> tauri::Result<Submenu<tauri::Wry>> {
    let items = [
        ...
        ("menu-shortcut-clear-pane", "Clear Focused Terminal", "Cmd+K", Some("Cmd+K")),
        ("menu-shortcut-search-pane", "Search Focused Terminal", "Cmd+F", Some("Cmd+F")),
        ...
        ("menu-shortcut-maximize-pane", "Maximize / Restore Workspace", "Cmd+Shift+Enter", Some("Cmd+Shift+Enter")),
        ("menu-shortcut-focus-next-pane", "Focus Next Terminal", "Cmd+]", Some("Cmd+]")),
        ("menu-shortcut-focus-previous-pane", "Focus Previous Terminal", "Cmd+[", Some("Cmd+[")),
        ("menu-shortcut-focus-next-terminal", "Focus Next Workspace", "Cmd+Shift+]", Some("Cmd+Shift+]")),
        ("menu-shortcut-focus-previous-terminal", "Focus Previous Workspace", "Cmd+Shift+[", Some("Cmd+Shift+[")),
        ("menu-shortcut-activate-sidebar", "Activate Sidebar Selection", "Cmd+Enter", Some("Cmd+Enter")),
        ("menu-shortcut-select-terminal", "Select Workspace 1-9", "Cmd+1 … Cmd+9", None),
